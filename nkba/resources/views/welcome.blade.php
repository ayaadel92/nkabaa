        ...
        <!-- Portfolio -->
          ...
          function GetValueSelected()
          {
            ...
            if(SelectElemet==1)
            {
             ...
             document.getElementById('areaSelectLab').style.visibility="hidden";
              ...
              document.getElementById("myButtonArea").onclick = function () {
                var ValueDoctorByArea=document.getElementById('area').value;
                location.href = "http://localhost:8000/SearchDoctor/"+ValueDoctorByArea;
                 
                console.log(ValueDoctorByArea);
