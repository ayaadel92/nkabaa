			...
			<table class=" table col-sm-8 teble-restrict">  
				...
				<tr>      
					...
					<tr>      
						...
						<td>
							{{ Form::textarea('medical_diagnosis', $transfer->medical_diagnosis,array('class'=>'form-control col-sm-9','disabled' ,'rows' => 3)) }}</td>
						</tr>
						...
						<tr>      
							...
							<td>{{ Form::text('lab_name', $transfer->lab_name,array('class'=>'form-control col-sm-8','disabled')) }}
							</td>
						</tr> 
						...
						<tr>      
							...
							<td>{{ Form::text('percentage', $transfer->percentage,array('class'=>'form-control col-sm-8','disabled')) }}
							</td>
						</tr>   

						<tr>      
							<td>{{Form::label(' التاريخ',' التاريخ',array('class' => 'style' ))}}</td>
							<td>{{ Form::date('transfer_date', $transfer->transfer_date,array('class'=>'form-control col-sm-8','disabled')) }}
							</td>
						</tr>  
					</table> 
				</div>
