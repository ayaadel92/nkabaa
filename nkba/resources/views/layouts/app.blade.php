...
<header id="header">
    <div id="stuck_container">
        <div class="container">
            <div class="row">
                <div class="grid_12">
                    <h1><a href="">نقابه المهندسين</a><span>صحتك تهمنا</span></h1>
                    <nav>
                         <div class="collapse navbar-collapse" id="navMain" >
                            <ul class="nav navbar-nav pull-right">
                                
                               <li><a class="btn txt-white green" style="background: #3cb371;" href="{{ url('/') }}">الرئيسية</a></li>
                                
                                <!-- Authentication Links -->
                                @if (Auth::guest())
                                
                                    <li>
                                    <a class="btn txt-white green" style="background: #3cb371;" href="{{ url('/login') }}">دخول</a>
                                    </li>
                                
                                  
                                   <li> 
                                    <a class="btn txt-white green" style="background: #3cb371;" href="{{ url('/register') }}">التسجيل</a></li>
                                ...
                                @else
                                    ...
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                            ...
                                            <li><a class="btn txt-white green" style="background: #3cb371;" href="{{ url('/logout') }}"><i class="fa fa-btn fa-sign-out"></i>خروج</a></li>
...
<footer id="footer">
    ...
    <div class="footer_bottom"><a href="http://www.templatemonster.com/" rel="nofollow">Designed By ITI Graduation Project</a></div>
</footer>
